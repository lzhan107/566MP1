...
/**
 *
 * @author Lei VenetianBlindValidation class is for validating nutrition.xml
 * against Venetian Blind pattern
 */
public class VenetianBlindValidation {
    ...
    public void validate() {
        try {
            ...
            xslStream = this.getClass().getClassLoader().getResourceAsStream("nutritionVenetianBlind.xsd");
            ...
            System.out.println("\n\n====  Validation against Venetian Blind Schema successfull!  ====\n\n");
    ...
    public void invalidate() {
        try {
            ...
            System.out.println("\n\n====  Validation against VenetianBlind Schema failed, the instance document is not valid!  ====\n\n");
            System.out.println(ex);
        } finally {
            if (xmlStream != null) {
                try {
